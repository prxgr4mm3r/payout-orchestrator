...
func (r passthroughTxRunner) WithinTx(ctx context.Context, fn func(store PayoutStore) error) error {
	if r.store == nil {
		return errors.New("payout transaction runner is not configured")
	}
...
func (r *DBTxRunner) WithinTx(ctx context.Context, fn func(store PayoutStore) error) error {
